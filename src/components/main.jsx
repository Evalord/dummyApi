...
const Main = () => {
    ...
    return (
        <div>
            <div> <button type='submit' className="add-btn" onClick={() => navigate(`/shoppingCard/${product.id}`)}>Add</button></div>
            <Slider {...settings}>
                <div>
                            ...
                            return (
                                <div className='content'>
                                    ...
                                    <div className="button">
                                        <button type='submit' className="delete-btn" onClick={() => {product.id}}>Delete</button>
